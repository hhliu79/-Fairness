...
def adversarial_debiasing(dataset_original_train, dataset_original_valid, dataset_original_test, privileged_groups, unprivileged_groups):
    ...
    dataset_original_valid.features = min_max_scaler.fit_transform(dataset_original_valid.features)
    dataset_original_test.features = min_max_scaler.fit_transform(dataset_original_test.features)
